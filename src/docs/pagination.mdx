...
<table style={{border: '1px solid orange', borderCollapse: 'collapse', width: '100%'}}>
  ...
  <tbody>
    <tr>
      <td style={{border: '1px solid orange', padding: '8px'}}><code>isActive</code></td>
      ...
      <td style={{border: '1px solid orange', padding: '8px'}}>Whether the link represents the current page</td>
    </tr>
    <tr>
      ...
      <td style={{border: '1px solid orange', padding: '8px'}}>Size variant</td>
    </tr>
    <tr>
      <td style={{border: '1px solid orange', padding: '8px'}}><code>className</code></td>
      <td style={{border: '1px solid orange', padding: '8px'}}><code>string</code></td>
