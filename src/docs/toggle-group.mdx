...
<table style={{ border: '1px solid orange', borderCollapse: 'collapse', width: '100%' }}>
  ...
  <tbody>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>type</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>"single" | "multiple"</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Selection mode for the toggle group</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>value</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>string | string[]</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Controlled value(s)</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>defaultValue</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>string | string[]</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Default value(s) for uncontrolled usage</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>onValueChange</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>(value: string | string[]) => void</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>-</td>
    ...
    <tr>
      ...
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>"horizontal"</code></td>
    ...
    <tr>
      ...
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Reading direction</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>variant</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>"default" | "outline"</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>"default"</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Visual variant applied to all items</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>size</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>"default" | "sm" | "lg"</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>"default"</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Size applied to all items</td>
    </tr>
  </tbody>
</table>
...
<table style={{ border: '1px solid orange', borderCollapse: 'collapse', width: '100%' }}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Unique value for this toggle item</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>disabled</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>boolean</code></td>
    ...
    <tr>
      ...
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>"default" | "outline"</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Override group variant for this item</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>size</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}><code>"default" | "sm" | "lg"</code></td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px', textAlign: 'left' }}>Override group size for this item</td>
    </tr>
  </tbody>
</table>
