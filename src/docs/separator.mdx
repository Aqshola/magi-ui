...
<table style={{ border: '1px solid orange', borderCollapse: 'collapse', width: '100%' }}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ border: '1px solid orange', padding: '8px' }}>The orientation of the separator</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>decorative</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>boolean</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>true</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>Whether the separator is decorative (no semantic meaning)</td>
    </tr>
    <tr>
