...
<table style={{ border: '1px solid orange', borderCollapse: 'collapse', width: '100%' }}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>"text"</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>HTML input type</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>placeholder</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>string</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>Placeholder text</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>value</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>string</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>Controlled value</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>defaultValue</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>string</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>Default value for uncontrolled</td>
    </tr>
    <tr>
      ...
      <td style={{ border: '1px solid orange', padding: '8px' }}>Disable input interaction</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>required</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>boolean</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>false</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>Mark field as required</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>onChange</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>function</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>Change event handler</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>onFocus</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>function</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>Focus event handler</td>
    </tr>
    <tr>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>onBlur</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}><code>function</code></td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>-</td>
      <td style={{ border: '1px solid orange', padding: '8px' }}>Blur event handler</td>
    </tr>
  </tbody>
</table>
